...
class VerifyMergeDictTest(unittest.TestCase):
    def test_merge_dict_ok(self):
        tests = {
            ...
            "first_dict_empty": [{}, {"test": "test"}, {"test": "test"}],
            "second_dict_empty": [{"test": "test"}, {}, {"test": "test"}],
        }
    ...
    def test_merge_dict_with_list_failing(self):
        ...
        for test_name, test in tests.items():
            ...
            self.assertTrue(
                InvalidConfigurationMergeParams.error_code
                == context.exception.error_code
            )

    def assert_merge_dict(
        self, dict1: dict, dict2: dict, expected_result: dict, message: str
    ):
        """
        ...
        self.assertTrue(
            ...
            "Failed test " + message + json.dumps(expected_result),
        )
