...
class Input:
    ...
    def __init__(self, configuration: dict = None):
        ...
        parser = argparse.ArgumentParser(description="Flex cli", add_help=True, prefix_chars='-')
        argument_type = '-'
        if self.configuration.get('handler_arguments').get("positional"):
            argument_type = ''
        parser.add_argument(argument_type + "handler",
                            nargs='?',
                            const='default',
                            default='default',
